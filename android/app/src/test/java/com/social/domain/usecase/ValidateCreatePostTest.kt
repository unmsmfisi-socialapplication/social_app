...
class ValidateCreatePostTest {
    ...
    @Test
    fun `invoke should return success resource when post creation is successful`() = runBlocking {
        ...
        val mockedResponse = CreatePostResponse (
            Id = 1,
            UserId = 2,
            Title = "ddd",
            Description = "ddd",
    ...
    @Test
    fun `invoke should return error resource when post creation fails`() = runBlocking {
        val createPostBody = CreatePostBody(
            userId = null,
            title = "aaa",
            description = "ddd",
