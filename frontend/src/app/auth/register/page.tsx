    ...
    return (
        <EnrollmentHoc>
            <WCardAuth title="Registro" variant="outlined">
                ...
                <WInput placeholder="Nombre Completo" size="small" fullWidth type="text" />
                <span>Correo</span>
                <WInput placeholder="Correo" size="small" fullWidth type="text" />
                <span>Nombre de Usuario</span>
                <WInput placeholder="Nombre de Usuario" size="small" fullWidth type="text" />
